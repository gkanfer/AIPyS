...
from AIPyS_old import AIPS_granularity as ag


def bayesModelTraining(files,kernelSize,pathOut, reportFile, savemode = False):
    """
    ...
    with pm.Model() as model_logistic_basic:
        ...
        trace = pm.sample(10, tune=10, target_accept=0.99, random_seed=RANDOM_SEED, cores=1)
    # performance table
