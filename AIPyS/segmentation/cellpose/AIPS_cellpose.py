...
from AIPyS_old.supportFunctions import AIPS_file_display as afd
...
class AIPS_cellpose:
    ...
    def cellpose_segmantation(self, image_input):
        ...
        self.mask, flows, styles, diams = model.eval(image_input, diameter=100, flow_threshold=None, channels=self.channels)
